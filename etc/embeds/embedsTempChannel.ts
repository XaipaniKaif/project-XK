...
export default {
    listParamTempVoiceChannel: { 
        ...
        component: new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(
            ...
            .addOptions(
                {label: 'Изменить название канала', value: 'editNameChannel', emoji: '📝'},
                {label: 'Изменить лимит участников канала', value: 'editLimitChannel', emoji: '🔢'},
                {label: 'Открыть канал для всех', value: 'setOpenChannel'},
                {label: 'Закрыть канал для всех', value: 'setCloseChannel'},
                {label: 'Добавить в черный список', value: 'setBlacklist'},
                {label: 'Добавить в белый список', value: 'setWhitelist'},
                {label: 'Выгнать и забанить участника', value: 'banUserVoiceChannel'},
                {label: 'Установить метку NFWS', value: 'setOnNFWS'},
                {label: 'Убрать метку NFWS', value: 'setOffNFWS'},
                {label: 'Получить полное управление над каналом', value: 'setAdminChannel'},
                {label: 'Замутить/Размутить пользователя', value: 'muteUserVoiceChannel'}
            )
        )
    },
    addBlacklistUser:  {
