...
export function data() {
    return (new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'user', name_localizations: { ru: 'пользователь' }, value: 'user' }, { name: 'track', name_localizations: { ru: 'песня' }, value: 'track' }, { name: 'playlist', name_localizations: { ru: 'плейлист' }, value: 'playlist' }))
